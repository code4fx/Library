...
//+------------------------------------------------------------------+
//|Prints error code, description and source function
//+------------------------------------------------------------------+
void print_error(string function) {
    int err_code = GetLastError();
    
    ResetLastError();
    
    printf("\nERROR: %i, %s in %s.\n", err_code, 
    ErrorDescription(err_code), function);
}

//+------------------------------------------------------------------+
//|Prints error code, description, custom description and 
//|source function
//+------------------------------------------------------------------+
void print_error(string desc, string function) {
    int err_code = GetLastError();
    
    ResetLastError();
    
    printf("\nERROR: %i, %s (%s) in %s.\n", err_code,
    ErrorDescription(err_code), desc, function);
}

//+------------------------------------------------------------------+
//|Prints error custom description and source function
//+------------------------------------------------------------------+
void print_init_error(string desc, string function) {
    printf("\nINITIALIZATION ERROR: (%s) in %s.\n", desc, function);
}
